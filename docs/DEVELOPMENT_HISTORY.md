...
### 15분 발표 PPT 구성 (비즈니스 중심)

**발표 전제**: 청중은 기술보다 비즈니스 가치에 관심. "날씨 예보" 비유를 처음부터 끝까지 관통.

| # | 슬라이드 제목 | 시간 | 핵심 메시지 |
|---|--------------|------|------------|
| 1 | 훅 — 2026-04-07 유가 $15 폭락 | 30초 | 뉴스 헤드라인 1장 + 숫자만, 침묵 시작 |
| 2 | 피해 규모 — 공감대 | 1분 | "유가 $1 차이 = 연간 수백억" 실제 기업 사례 |
| 3 | 기존 방식의 한계 | 1분 | 뉴스 보기·직관·엑셀 → 느리다·주관적·전문지식 필요 |
| 4 | 제품 한 줄 소개 | 30초 | 대시보드 스크린샷 1장, 기술 설명 없이 |
| 5 | 작동 원리 (비유) | 1분30초 | 기상청처럼 500개 신호 → 7일 유가 예보 |
| 6 | 핵심 기능 3가지 | 1분 | 7일 예측 / 리스크 알림 / 블랙스완 경보 |
| 6-A | **데이터 출처 — 공식 기관** | 45초 | EIA·CFTC·NewsAPI·Yahoo — 공신력 강조 |
| 6-B | **한계도 공개 — 투명성** | 45초 | 잘 맞는 상황 vs 솔직한 한계 병렬 제시 |
| 7 | 성능 숫자 + 타임라인 이미지 | 1분 | 오차 40% 개선, 방향성 61%, MASE=0.602 |
| 8 | 타겟 고객 | 1분30초 | 물류사·트레이더·정유구매팀 페르소나 |
| 9 | 수익 모델 | 1분 | ₩0 / ₩49만 / ₩129만, "Pro 100명 = 월 1.3억" |
| 10 | 왜 지금, 왜 우리 | 1분 | 4주 MVP→SaaS, 확장성 (API·커스텀 알림) |
| 11 | 시연 예고 | 15초 | "지금 실제로 작동하는 화면" |
| 12 | 마무리 · CTA | 30초 | "날씨 예보 없이 여행 안 가듯, 유가 예보 없이 사업하지 마세요" |

**시연 5분 흐름**: 로그인(10초) → 오늘 예측+리스크 등급(1분) → 7일 차트(1분) → HIGH 리스크 시나리오(1분) → 구독 플랜 화면(30초) → Q&A
